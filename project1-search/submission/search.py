...
def depthFirstSearch(problem):
    ...
    # didn't reach goal, return empty(failure)
    return []
    ...
    while not pq.isEmpty():
      ...
      if current[0][0] not in visited:
        ...
        for successor in problem.getSuccessors(current[0][0]):
          pq.push([successor[0], current[0][1] + [successor[1]]], problem.getCostOfActions(current[0][1]) + successor[2])
...
def aStarSearch(problem, heuristic=nullHeuristic):
    ...
    while not pq.isEmpty():
      ...
      if current[0][0] not in visited:
        ...
        # successor: [state, direction, cost]
        for successor in problem.getSuccessors(current[0][0]):
          pq.push([successor[0], current[0][1] + [successor[1]]], problem.getCostOfActions(current[0][1]) + successor[2] + heuristic(successor[0], problem))
